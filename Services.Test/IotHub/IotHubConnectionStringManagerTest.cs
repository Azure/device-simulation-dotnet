...
namespace Services.Test.IotHub
{
    public class IotHubConnectionStringManagerTest
    {
        ...
        private readonly Mock<ICheckHubPermissionsWrapper> checkPermsWrapper;
        ...
        public IotHubConnectionStringManagerTest()
        {
            ...
            this.checkPermsWrapper = new Mock<ICheckHubPermissionsWrapper>();
            ...
            this.target = new IotHubConnectionStringManager(this.config, this.mockFactory.Object, this.mockDiagnosticsLogger.Object, this.checkPermsWrapper.Object, this.mockLogger.Object);
        }
