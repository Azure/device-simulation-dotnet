    ...
    public class IotHubConnectionStringManager : IIotHubConnectionStringManager
    {
        ...
        public async Task ValidateConnectionStringAsync(string connectionString)
        {
            ...
            if (!match.Success)
            {
                ...
                this.diagnosticsLogger.LogDiagnosticsData(SERVICE_ERROR_EVENT, message);
        ...
        private void ValidateExistingIotHub(string connectionString)
        {
            ...
            catch (Exception e)
            {
                ...
                this.diagnosticsLogger.LogDiagnosticsData("Server Error", $"{message}: {e.Message}");
        ...
        private async Task ValidateReadPermissionsAsync(string connectionString)
        {
            ...
            catch (Exception e)
            {
                ...
                this.log.Error(message, e);
                this.diagnosticsLogger.LogDiagnosticsData(SERVICE_ERROR_EVENT, $"{message}: {e.Message}");
                throw new IotHubConnectionException(message, e);
            }
        }
        ...
        private async Task ValidateWritePermissionsAsync(string connectionString)
        {
            ...
            do
            {
                ...
                catch (Exception e)
                {
                    ...
                    this.diagnosticsLogger.LogDiagnosticsData(SERVICE_ERROR_EVENT, $"{message}. DeviceId = {testDeviceId}, Exception = {e.Message}");
                    throw new IotHubConnectionException(message, e);
                }
            ...
            if (response != null)
            {
                ...
                this.diagnosticsLogger.LogDiagnosticsData(SERVICE_ERROR_EVENT, $"{message}: {testDeviceId}");
                throw new IotHubConnectionException(message);
            }
        }
        ...
        private async Task UseDefaultIotHubAsync()
        {
            ...
            catch (Exception e)
            {
                ...
                this.diagnosticsLogger.LogDiagnosticsData(SERVICE_ERROR_EVENT, $"{msg}. FilePath = {this.connStringFilePath}, Exception = {e.Message}");
                throw;
            }
        }
