...
namespace Microsoft.Azure.IoTSolutions.DeviceSimulation.Services.DataStructures
{
    ...
    /// not automatically injected. This class helps ensuring that these classes are
    /// used as intended, i.e. initialized after the ctor, before being used.
    /// </summary>
    public class Instance : IInstance
    {
            ...
            int lineNumber = 0)
        {
            ...
            throw new ApplicationException($"Call from an instance not yet initializated ({filePath}:{lineNumber})");
        }
    }
}
