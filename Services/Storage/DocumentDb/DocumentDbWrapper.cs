...
namespace Microsoft.Azure.IoTSolutions.DeviceSimulation.Services.Storage.DocumentDb
{
    public interface IDocumentDbWrapper
    {
        ...
        Task<ResourceResponse<Document>> CreateAsync(
            IDocumentClient client,
            StorageConfig cfg,
            Resource resource);

        Task<ResourceResponse<Document>> UpsertAsync(
            IDocumentClient client,
            StorageConfig cfg,
            Resource resource);
        ...
        Task<ResourceResponse<Document>> ReadAsync(
            IDocumentClient client,
            StorageConfig cfg,
            string docId);
    ...
    public class DocumentDbWrapper : IDocumentDbWrapper
    {
        ...
        public async Task<ResourceResponse<Document>> CreateAsync(
            IDocumentClient client,
            StorageConfig cfg,
            Resource resource)
        {
        ...
        public async Task<ResourceResponse<Document>> ReadAsync(
            IDocumentClient client,
            StorageConfig cfg,
            string docId)
        {
