...
namespace SimulationAgent.Test.SimulationThreads
{
    public class DeviceConnectionTaskTest
    {
        ...
        private readonly Mock<ISimulationConcurrencyConfig> mockSimulationConcurrencyConfig;
        private readonly Mock<ILogger> mockLogger;
        private readonly DeviceConnectionTask target;

        private ConcurrentDictionary<string, Mock<IDeviceConnectionActor>> mockDeviceConnectionActors;
        private ConcurrentDictionary<string, IDeviceConnectionActor> mockDeviceConnectionActorObjects;
        ...
        public DeviceConnectionTaskTest()
        {
            ...
            this.mockSimulationConcurrencyConfig.SetupGet(x => x.MaxPendingTasks).Returns(MAX_PENDING_TASKS);
            this.mockLogger = new Mock<ILogger>();

            this.target = new DeviceConnectionTask(this.mockSimulationConcurrencyConfig.Object, this.mockLogger.Object);
        }
